...
function Notices() {
    ...
    async function saveNotice(e) {
        ...
        const api_data = await fetch("https://a2z-solutions-backend.onrender.com/api/admin/notice", {
            method: "POST",
    ...
    return (
        <>   {ValidUser && 
            <>
            <Navbar />
            <div className="container flex flex-col flex-wrap justify-center m-auto my-3 sm:flex-row">
                <div className="flex justify-center w-full p-4 m-2 border rounded dark:border-0 sm:w-full md:w-1/2 ">
                        ...
                        <div class="mt-8">
                            ...
                            >
                                ...
                                <div className="my-4">
                                    ...
                                    />
                                    <label
                                        className="mx-2 form-check-label dark:text-white"
                ...
                <div className="w-full p-4 m-2 border rounded dark:border-0 sm:w-full md:w-1/2">
                    <h4 className="text-2xl text-center dark:text-white">
                        Published Notices
                    </h4>
