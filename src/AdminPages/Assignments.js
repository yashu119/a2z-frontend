...
function Assignments() {
    ...
    async function getAssignment() {
        const api_data = await fetch("https://a2z-solutions-backend.onrender.com/api/admin/assignment", {
            method: "GET",
    ...
    async function saveAssignment(e) {
        ...
        const api_data = await fetch("https://a2z-solutions-backend.onrender.com/api/admin/assignment/new/", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                name: name,
                ...
                <>
                    <div class="relative z-10 flex flex-col items-center w-full mb-8">
                        ...
                        <div className="container mt-12">
                            <div className="container border rounded-md sm:x-28">
