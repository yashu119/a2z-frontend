...
function Assignments() {
  ...
  async function getAssignment() {
    setLoading(true)
    const api_data = await fetch("https://a2z-solutions-backend.onrender.com/api/assignment", {
      method: "GET",
  ...
  return (
    <>
      ...
      {ValidUser &&
        <>
          <Navbar />
          <h1 class="mt-6 font-extrabold leading-tight text-center text-2xl sm:text-4xl">
            Your Tasks
          </h1>
          <svg
            width="40"
