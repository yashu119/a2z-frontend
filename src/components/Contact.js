...
function Contact() {
    ...
    async function submitData(e) {
        e.preventDefault();
        setLoading(true);
        const api_data = await fetch("https://a2z-solutions-backend.onrender.com/api/new/query", {
            method: "POST",
                            ...
                            <div class="flex flex-wrap -m-2 border p-3 rounded-xl">
                                ...
                                <div class="p-2 w-1/2">
                                    <div class="relative">
                                        ...
                                        <input type="text" id="name" name="name" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-red-500 focus:bg-white focus:ring-2 focus:ring-red-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" value={Name}
                                ...
                                <div class="p-2 w-1/2">
                                    <div class="relative">
                                        ...
                                        <input type="email" id="emailss" name="email" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-red-500 focus:bg-white focus:ring-2 focus:ring-red-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" value={Email}
                                ...
                                <div class="p-2 w-full">
                                    <button class="flex mx-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded-lg text-lg">{Loading ? "" : "Submit"}   <svg
                                        width="20"
                                        height="20"
                                        fill="currentColor"
